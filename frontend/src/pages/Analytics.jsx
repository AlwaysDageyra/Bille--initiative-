    ...
    return (
      <div>
        <div className="mb-7">
          ...
          <p className="mt-1 text-sm text-slate-500">Volume, routing accuracy, and turnaround across all correspondence.</p>
        </div>
        ...
        <ChartCard title="Correspondence by Department">
          <ResponsiveContainer>
            <BarChart data={stats.byDept} margin={{ left: -10 }}>
              ...
              <XAxis dataKey="name" tick={{ fontSize: 12, fill: "#64748b" }} interval={0} angle={-15} textAnchor="end" height={50} />
        ...
        <ChartCard title="Urgency Distribution" height={240}>
          <ResponsiveContainer>
            <BarChart data={stats.byUrgency} layout="vertical" margin={{ left: 10 }}>
              ...
              <YAxis type="category" dataKey="urgency" tick={{ fontSize: 12, fill: "#64748b" }} width={60} />
              <Tooltip cursor={{ fill: "#f8fafc" }} />
