...
export default function Account() {
  ...
  return (
    <div>
      <div className="mb-7">
        <h1 className="text-2xl font-extrabold tracking-tight text-ink-900">Account Settings</h1>
        <p className="mt-1 text-sm text-slate-500">Signed in as <strong>{user.username}</strong>.</p>
      </div>
